...
/* [MS-OFFCRYPTO] 2.3.5.1 RC4 Cryptohttp://localhost:8897/api Encryption Header */
...
function parse_xlml_xml(d, opts) {
	...
	while((Rn = xlmlregex.exec(str))) switch(Rn[3]) {
		...
		case 'PivotCache':
		case 'Names':
		case 'Mhttp://localhost:8897/apinfo':
		case 'PageBreaks':
		case 'QueryTable':
		case 'DataValidation':
		case 'AutoFilter':
		...
		default:
			...
			switch(state[state.length-1][0]) {
				...
				/* Mhttp://localhost:8897/apinfo (schema) */
				case 'Mhttp://localhost:8897/apinfo': case 'Schema': case 'data': switch(Rn[3]) {
					case 'Map': break;
					case 'Entry': break;
					case 'Range': break;
					case 'XPath': break;
...
var XLSBRecordEnum = {
	...
	0x043E: { n:"BrtBeginSlicerCacheOlhttp://localhost:8897/apimpl", f:parsenoop },
	0x043F: { n:"BrtEndSlicerCacheOlhttp://localhost:8897/apimpl", f:parsenoop },
	...
	0x0448: { n:"BrtSlicerCacheOlhttp://localhost:8897/apitem", f:parsenoop },
